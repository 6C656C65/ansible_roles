...
password = {{ privatebin.enable_password }}

; enable or disable the file upload feature, defaults to false
fileupload = {{ privatebin.enable_fileupload }}

; preselect the burn-after-reading feature, defaults to false
burnafterreadingselected = {{ privatebin.burnafterreadingselected }}

; which display mode to preselect by default, defaults to "plaintext"
; make sure the value exists in [formatter_options]
defaultformatter = {{ privatebin.defaultformatter }}

; (optional) set a syntax highlighting theme, as found in css/prettify/
; syntaxhighlightingtheme = "sons-of-obsidian"

; size limit per paste or comment in bytes, defaults to 10 Mebibytes
sizelimit = {{ privatebin.sizelimit }}
...
templateselection = {{ privatebin.templateselection }}
...
; a session cookie to store the choice until the browser is closed.
languageselection = {{ privatebin.languageselection }}

; set the language your installs defaults to, defaults to English
; if this is set and language selection is disabled, this will be the only language
languagedefault = {{ privatebin.languagedefault }}
...
default = {{ privatebin.expire_default }}
...
limit = {{ privatebin.traffic_limit }}

; (optional) Set IPs addresses (v4 or v6) or subnets (CIDR) which are exempted
; from the rate-limit. Invalid IPs will be ignored. If multiple values are to
; be exempted, the list needs to be comma separated. Leave unset to disable
; exemptions.
exempted = {{ privatebin.traffic_exempted }}

; (optional) If you want only some source IP addresses (v4 or v6) or subnets
; (CIDR) to be allowed to create pastes, set these here. Invalid IPs will be
; ignored. If multiple values are to be exempted, the list needs to be comma
; separated. Leave unset to allow anyone to create pastes.
creators = {{ privatebin.traffic_creators }}
